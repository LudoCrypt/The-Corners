...
//			.setDimensions(new EntityDimensions(0.375F, 0.875F, false)).maxBlockTrackingRange(10).defaultAttributes(CorvusEntity.createAttributes()).build());
	public static final EntityType<BoatEntity> GAIA_BOAT = get("gaia_boat",
			QuiltEntityTypeBuilder.create(SpawnGroup.MISC, CornerBoat.GAIA.factory(false)).setDimensions(EntityDimensions.changing(1.375f, 0.5625f)).maxChunkTrackingRange(10).build());
	public static final EntityType<BoatEntity> GAIA_CHEST_BOAT = get("gaia_chest_boat",
			QuiltEntityTypeBuilder.create(SpawnGroup.MISC, CornerBoat.GAIA.factory(true)).setDimensions(EntityDimensions.changing(1.375f, 0.5625f)).maxChunkTrackingRange(10).build());
