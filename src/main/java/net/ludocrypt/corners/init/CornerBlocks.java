...
public class CornerBlocks {
	...
	private static final Map<ItemGroup, Set<Item>> CORNERS_ITEM_GROUP_ENTRIES = Maps.newHashMap();

	public static final Block STONE_PILLAR = get("stone_pillar", new ThinPillarBlock(QuiltBlockSettings.copyOf(Blocks.STONE_BRICKS)), ItemGroups.NATURAL);

	public static final Block WOODEN_RADIO = get("wooden_radio", new RadioBlock(QuiltBlockSettings.copyOf(Blocks.OAK_WOOD)), ItemGroups.REDSTONE);
	public static final Block TUNED_RADIO = get("tuned_radio", new RadioBlock(QuiltBlockSettings.copyOf(Blocks.OAK_WOOD)), ItemGroups.REDSTONE);
	public static final Block BROKEN_RADIO = get("broken_radio", new RadioBlock(QuiltBlockSettings.copyOf(Blocks.OAK_WOOD)), ItemGroups.REDSTONE);
	...
	public static final Block NYLON_FIBER_STAIRS = get("nylon_fiber_stairs", new CornerStairsBlock(NYLON_FIBER_BLOCK.getDefaultState(), QuiltBlockSettings.copyOf(Blocks.WHITE_WOOL)), ItemGroups.BUILDING_BLOCKS);
	...
	private static <B extends Block> B get(String id, B block, ItemGroup group) {
