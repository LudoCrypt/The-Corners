...
public class CornerPaintings {
	...
	public static final PaintingMotive COMMUNAL_CORRIDORS = get("communal_corridors", DimensionalPaintingMotive.create(32, 32, CornerWorld.COMMUNAL_CORRIDORS_WORLD_REGISTRY_KEY, (player, painting) -> new Vec3d(player.getBlockX() % 8, 2.0D, player.getBlockZ() % 8).add(player.getX(), 0.0D, player.getZ()).add(-2.0D, 0, -2.0D)));
