...
public class CornerPaintings {
	...
	public static final PaintingMotive COMMUNAL_CORRIDORS = get("communal_corridors", DimensionalPaintingMotive.create(32, 32, CornerWorld.COMMUNAL_CORRIDORS_WORLD_REGISTRY_KEY, (player, painting) -> player.getPos().multiply(8).add(1.5, -player.getPos().getY(), 1.5).add(0, 1, 0)));
