...
public class CornerPaintings {
	...
	public static final PaintingMotive HOARY_CROSSROADS = get("hoary_crossroads", DimensionalPaintingMotive.create(32, 48, CornerWorld.HOARY_CROSSROADS.getWorldKey(), (player, painting) -> player.getPos().subtract(new Vec3d(player.getX() % 8192.0D, player.getY(), player.getZ() % 8192.0D)).add(4096.0D, 263.0D, 0.0D).add(4.0D, 0, 4.0D)));
